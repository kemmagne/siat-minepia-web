var deployJava = function () {
    ...
    var d = {
		...
		var appName = navigator.appName;
            //    alert(o);
             //   alert(navigator.appName);
                ...
                else if (o.indexOf("trident") != -1 || appName.indexOf("Internet Explorer") != -1) {
                    this.browserName = "MSIE";
                    this.browserName2 = "MSIE"
                }
                else {
        ...
        IEInstall: function () {
			alert("JRE(Java Runtime Environment) must be intalled in your computer.\nPlease, visit the web site. (http://java.com/)");	
			window.open("http://java.com/ko/");            
			return false
        },
        done: function (p, o) {},
        FFInstall: function () {
