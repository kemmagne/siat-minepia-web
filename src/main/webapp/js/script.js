...
function changeRequiredState(required) {
    $("#paymentNature").attr("required", required);
    $("#paymentAmount").attr("required", required);
}
...
function disableF5(e) {
    if ((e.which || e.keyCode) == 116 || (e.ctrlKey && e.keyCode == 82) || (e.which || e.keyCode) == 63240)
        e.preventDefault();
}
;
