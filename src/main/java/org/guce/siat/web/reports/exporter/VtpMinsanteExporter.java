...
public class VtpMinsanteExporter extends AbstractReportInvoker {
    ...
    public JRBeanCollectionDataSource getReportDataSource() {
        ...
        if ((file != null)) {
            ...
            vtpMinsanteVo.setAttestation(vtpMinsanteVo.getDecisionNumber() + PREFIX + new SimpleDateFormat("dd/MM/yyyy").format(signatoryDate == null ? java.util.Calendar.getInstance().getTime() : signatoryDate));
        }
