...
public class CtCctCpIExporter extends AbstractReportInvoker
{
	...
	public JRBeanCollectionDataSource getReportDataSource()
	{
		...
		if ((file != null))
		{
			...
			{
				ctCctCpIFileVo.setConsignorName(file.getClient().getCompanyName());
				ctCctCpIFileVo.setConsignorAddress1(file.getClient().getFirstAddress());
				ctCctCpIFileVo.setConsignorCountry(file.getClient().getCountry() != null ? file.getClient().getCountry()
			...
			final List<CtCctCpIFileItemVo> fileItemVos = new ArrayList<CtCctCpIFileItemVo>();
