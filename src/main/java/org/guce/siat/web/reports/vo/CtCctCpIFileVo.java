...
public class CtCctCpIFileVo extends AbstractFileVo<CtCctCpIFileItemVo> {
     ...
     *
     * @param exporterName the new consignor name
     */
     ...
     *
     * @param exporterAddress1 the new consignor address1
     */
    public void setExporterAddress1(final String exporterAddress1) {
     ...
     *
     * @param exporterAddress2 the new consignor address2
     */
    public void setExporterAddress2(final String exporterAddress2) {
     ...
     *
     * @param exporterCountry the new consignor country
     */
    public void setExporterCountry(final String exporterCountry) {
