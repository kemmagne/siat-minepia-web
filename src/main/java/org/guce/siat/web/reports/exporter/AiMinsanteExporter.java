...
public class AiMinsanteExporter extends AbstractReportInvoker {
    ...
    public JRBeanCollectionDataSource getReportDataSource() {
        ...
        if ((file != null) && (file.getClient() != null)) {
            ...
            aiMinsanteFileVo.setImporterAddress(new StringBuilder().append(file.getClient().getPostalCode())
                    .append(" , ")
                    .append(file.getClient().getFirstAddress())
                    .append(" , ")
                    .append(file.getClient().getCity())
                    .append(" , ")
                    .append(file.getClient().getCountry().getCountryName())
                    .toString());
            ...
            aiMinsanteFileVo.setManufacturerAddress(new StringBuilder().append(manufacturerAddress1 == null ? (manufacturerAddress2 == null ? "" : manufacturerAddress2 + " , ") : (manufacturerAddress1 + " , "))
                    .append(manufacturerVille == null ? "" : manufacturerVille + " , ")
                    .append(manufacturerPays == null ? "" : manufacturerPays)
                    .toString());

            aiMinsanteFileVo.setSupplierAddress(new StringBuilder().append(supplierAddress1 == null ? (supplierAddress2 == null ? "" : supplierAddress2 + " , ") : (supplierAddress1 + " , "))
                    .append(supplierVille == null ? "" : supplierVille + " , ")
                    .append(supplierPays == null ? "" : supplierPays)
                    .toString());
