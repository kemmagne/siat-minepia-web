 ...
 */
public class CtCctCpEFileItemVo extends AbstractFileItemVo {
     ...
     *
     * @param distinguishingMark the new distinguishing mark
     */
     ...
     *
     * @param numberOfPackages the new number of packages
     */
     ...
     *
     * @param declaredQuantity the new declared quantity
     */
