...
public class VtdMinsanteExporter extends AbstractReportInvoker {
    ...
    public JRBeanCollectionDataSource getReportDataSource() {
        ...
        if ((file != null)) {
            ...
            vtdMinsanteVo.setAttestation(vtdMinsanteVo.getDecisionNumber() + PREFIX + new SimpleDateFormat("dd/MM/yyyy").format(signatoryDate == null ? java.util.Calendar.getInstance().getTime() : signatoryDate));
        }
