...
public class CtCctCpEFileVo extends AbstractFileVo<CtCctCpEFileItemVo>
{
	 ...
	 *
	 * @param localPlantProtectionOrganisation
	 *           the new local plant protection organisation
	 */
	 ...
	 *
	 * @param foreignPlantProtectionOrganisation
	 *           the new foreign plant protection organisation
	 */
	 ...
	 *
	 * @param additionalDeclaration
	 *           the new additional declaration
	 */
	 ...
	 *
	 * @param typeOfTreatment
	 *           the new type of treatment
	 */
	 ...
	 *
	 * @param chemicalProductActiveMatter
	 *           the new chemical product active matter
	 */
	 ...
	 *
	 * @param phytosanitaryCertificateNumber
	 *           the new phytosanitary certificate number
	 */
	 ...
	 *
	 * @param copyOrOriginal
	 *           the new copy or original
	 */
	 ...
	 *
	 * @param packagedOrRepackaged
	 *           the new packaged or repackaged
	 */
