...
public class LoginBean implements Serializable {
    ...
    private void userDashboardsRender() {
        ...
        List<FileTypeCode> apCodes = Arrays.asList(FileTypeCode.AIE_MINADER, FileTypeCode.EH_MINADER,
                ...
                FileTypeCode.AS_MINCOMMERCE, FileTypeCode.CO_MINFOF_FORET, FileTypeCode.CO_MINFOF_FAUNE, FileTypeCode.BSBE_MINFOF, FileTypeCode.FIMEX_WF, FileTypeCode.ATM_MINEPIA);
        ...
        List<FileTypeCode> cctCodes = Arrays.asList(FileTypeCode.CCT_CSV, FileTypeCode.CCT_CT, FileTypeCode.CC_CT, FileTypeCode.CQ_CT,
                FileTypeCode.CCT_CT_E, FileTypeCode.CCT_CT_E_ATP, FileTypeCode.CCT_CT_E_FSTP, FileTypeCode.CCT_CT_E_PVE, FileTypeCode.CCT_CT_E_PVI, FileTypeCode.CCS_MINSANTE);
