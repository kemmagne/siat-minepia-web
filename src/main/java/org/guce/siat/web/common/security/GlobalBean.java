...
public class GlobalBean implements Serializable {
    ...
    public List<Authority> getAuthorities() {
        if (authorities == null) {
            ...
            if (context != null) {
                ...
                Set<Authority> setAuthorities = (Set<Authority>) (session.getAttribute("authorities"));
                authorities = new ArrayList<>(setAuthorities);
            }
        }
        return authorities;
    }
     ...
     *
     * @param paramsService the new params service
     */
