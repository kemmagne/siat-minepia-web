...
/**
 * The Class HistoryCiblageController.
 */
@ManagedBean(name = "historyCiblageController")
@ViewScoped
public class HistoryCiblageController extends AbstractController<AuditEntity>
{

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -5541603803269152395L;

	/** The Constant LOG. */
	private static final Logger LOG = LoggerFactory.getLogger(HistoryCiblageController.class);
	...
	/**
	 * Instantiates a new history ciblage controller.
	 */
	public HistoryCiblageController()
	{
	...
	public void init()
	{
		...
		{
			LOG.debug(Constants.INIT_LOG_INFO_MESSAGE, HistoryCiblageController.class.getName());
		}
		super.setService(auditEntityService);
		super.setPageUrl(ControllerConstants.Pages.BO.GR.CIBLAGE_HISTORY_PAGE);
		initSearch();
	}
	...
	public void initSearch()
	{
		...
		historyModelsList = generateHistoryModelList(auditEntityService.findByModel(Ciblage.class.getSimpleName()));
	}
	...
	public void doSearch()
	{
		...
		else if (filter.getBeginDate() != null || filter.getEndDate() != null)
		{
			...
			historyModelsList = generateHistoryModelList(auditEntityService.findByFilterAndModel(filter,
					Ciblage.class.getSimpleName()));
		}
		else
		{
			historyModelsList = generateHistoryModelList(auditEntityService.findByModel(Ciblage.class.getSimpleName()));
