...
public class ScheduleController implements Serializable
{
				...
				if (isFormInspectionWorkWeekConfig && !checkHolidayDate(dateIncrement))
				{
					...
					for (final InspectorCheck inspectorCheck : inspectorCheckList)
					{
						...
						if (inspectorCheck.getChecked())
						{
							...
							// inspector is avalable for inspection
							{
	 ...
	 *           the new inspection work week config service
	 */
	 ...
	 *
	 * @param calendarEndtDate
	 *           the new calendar endt date
	 */
	 ...
	 *
	 * @param workYearConfigListOfCurrentYear
	 *           the new work year config list of current year
	 */
	 ...
	 *
	 * @param inspectorCheckList
	 *           the new inspector check list
	 */
	 ...
	 *
	 * @param inspectionWorkDayConfigsList
	 *           the new inspection work day configs list
	 */
	 ...
	 *
	 * @param proposedEvents
	 *           the new proposed events
	 */
	 ...
	 *           the new inspection work week config list
	 */
	 ...
	 *
	 * @param carAvailableList
	 *           the new car available list
	 */
	 ...
	 *
	 * @param rdvConfirmation
	 *           the new rdv confirmation
	 */
