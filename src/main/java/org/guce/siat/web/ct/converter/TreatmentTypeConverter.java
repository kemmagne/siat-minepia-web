...
/**
 * The Class TreatmentTypeConverter.
 */
@ManagedBean(name = "treatmentTypeConverter")
@RequestScoped
public class TreatmentTypeConverter implements Converter
{
	...
	public Object getAsObject(final FacesContext facesContext, final UIComponent component, final String value)
	{
		...
		return this.treatmentTypeService.find(getKey(value));
	}
	...
	public String getAsString(final FacesContext facesContext, final UIComponent component, final Object object)
	{
		...
		{
			final TreatmentType o = (TreatmentType) object;
		...
		else
		{
			Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}",
					new Object[]
					{ object, object.getClass().getName(), TreatmentType.class.getName() });
			return null;
		}
	}
