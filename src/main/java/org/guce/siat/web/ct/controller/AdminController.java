...
public class AdminController extends AbstractController<User> {
     ...
     *
     * @param ministriesList the ministriesList to set
     */
     ...
     *
     * @param allMinHaveAdminMsg the allMinHaveAdminMsg to set
     */
     ...
     *
     * @param allOrgHaveAdminMsg the allOrgHaveAdminMsg to set
     */
