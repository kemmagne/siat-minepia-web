...
public class FileTypeController extends AbstractController<FileType> {
	...
	public void init() {
		...
		servicePickList = new DualListModel<Service>(new ArrayList<Service>(), new ArrayList<Service>());
	...
	public void prepareEdit() {
		...
		for (final Service service : selected.getServiceList()) {
	...
	public void edit() {
		...
		final List<org.guce.siat.common.model.FileTypeService> targetFileTypeService = new ArrayList<org.guce.siat.common.model.FileTypeService>();
		...
		for (final Service service : servicePickList.getTarget()) {
			...
			fileTypeService_.setFileType(selected);
			fileTypeService_.setService(service);
			targetFileTypeService.add(fileTypeService_);
		}
		fileTypeService.update(selected, targetFileTypeStep, targetFileTypeService);
	}
