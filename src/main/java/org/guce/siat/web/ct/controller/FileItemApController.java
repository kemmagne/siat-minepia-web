...
public class FileItemApController extends AbstractController<FileItem>
{
	...
	public void filterFormDashboard()
	{
		...
		{
			case "unread":
				this.filesList = new ArrayList<File>(unreadFilesList);
				break;
			case "oneday":
				this.filesList = new ArrayList<File>(receivedBeforOneDayFilesList);
				break;
			case "towday":
				this.filesList = new ArrayList<File>(receivedMoreTwoDaysFilesList);
				break;
			case "between":
				this.filesList = new ArrayList<File>(receivedBetweenTwoDayFilesList);
				break;
			case "draft":
				this.filesList = new ArrayList<File>(draftFilesList);
				break;
			case "all":
				this.filesList = null;
				break;
	...
	public List<File> getFilesList()
	{
		...
		{
			filesList = new ArrayList<File>(extractFiles());
		}
	...
	public Set<File> getUnreadFilesList()
	{
		...
		{
			unreadFilesList = new HashSet<File>();
		}
	 ...
	 *
	 * @param unreadFilesList
	 *           the unreadFilesList to set
	 */
	...
	public Set<File> getDraftFilesList()
	{
		...
		{
			draftFilesList = new HashSet<File>();
		}
	 ...
	 *
	 * @param draftFilesList
	 *           the draftFilesList to set
	 */
	...
	public Set<File> getReceivedBeforOneDayFilesList()
	{
		...
		{
			receivedBeforOneDayFilesList = new HashSet<File>();
		}
	 ...
	 *
	 * @param receivedBeforOneDayFilesList
	 *           the receivedBeforOneDayFilesList to set
	 */
	...
	public Set<File> getReceivedMoreTwoDaysFilesList()
	{
		...
		{
			receivedMoreTwoDaysFilesList = new HashSet<File>();
		}
	 ...
	 *
	 * @param receivedMoreTwoDaysFilesList
	 *           the receivedMoreTwoDaysFilesList to set
	 */
	...
	public Set<File> getReceivedBetweenTwoDayFilesList()
	{
		...
		{
			receivedBetweenTwoDayFilesList = new HashSet<File>();
		}
	 ...
	 *
	 * @param receivedBetweenTwoDayFilesList
	 *           the receivedBetweenTwoDayFilesList to set
	 */
	 ...
	 *
	 * @param filesListFiltred
	 *           the new files list filtred
	 */
