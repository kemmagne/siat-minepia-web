...
public class AttachmentController implements Serializable {
     ...
     *
     * @param selectedAttachment the selectedAttachment to set
     */
     ...
     *
     * @param showPanelViewPdf the showPanelViewPdf to set
     */
     ...
     *
     * @param showPanelViewJpeg the showPanelViewJpeg to set
     */
     ...
     * Sets the stream.
     *
     * @param streamJpeg the new stream jpeg
     */
     ...
     * Sets the content.
     *
     * @param streamPdf the new stream pdf
     */
